...
import { Building2, Droplet, Loader2, MapPin } from "lucide-react"
...
const HospitalSignup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validation = hospitalSignupSchema.safeParse({
      email,
      password,
      hospitalName,
      address,
    ...
    try {
      const { error } = await signUp(email, password, hospitalName, "hospital")
      ...
      <div className="w-full max-w-2xl">
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Create a hospital account</CardDescription>
          </CardHeader>
